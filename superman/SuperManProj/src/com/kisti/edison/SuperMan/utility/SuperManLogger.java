...
*/
package com.kisti.edison.SuperMan.utility;
...
/*****
 * Logger (extension) class for SuperMan logging
 * @author Young Suh
 */
public class SuperManLogger extends Logger{
	/***
     ...
     * @param name
     */
    public SuperManLogger(String loggerName) {
    	super(loggerName);
